...
from services.market_data import (  # noqa: E402
    ...
    load_daily_ohlc as _md_load_daily_ohlc,
    load_fut_volume as _md_load_fut_volume,
...
async def load_fut_volume(offline: bool, from_date: date, to_date: date) -> dict:
    """Front-month futures volume by minute, from data/nifty_fut_volume.json."""
    return await _md_load_fut_volume(offline, from_date, to_date)
